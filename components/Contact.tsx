        ...
        >
          ...
          >
            ...
            <motion.a
              ...
              className="px-8 py-4 border-2 border-neutral-700 text-neutral-200 rounded-lg font-semibold text-lg hover:border-primary hover:text-primary transition-all duration-300 flex items-center gap-2"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 border-2 border-neutral-700 text-neutral-200 rounded-lg font-semibold text-lg hover:border-secondary hover:text-secondary transition-all duration-300 flex items-center gap-2"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
